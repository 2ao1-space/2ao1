...
export default function ContactIndex() {
  return (
    <section className="md:py-20 flex flex-col items-center">
      ...
      <h1
        id="title"
        className="font-mainHead text-2xl sm:text-6xl lg:text-8xl xl:text-[5rem] leading-tight lg:leading-[6rem] text-center py-10 lg:py-16"
      >
      ...
      {/* redirect buttons */}
      <div className="w-full flex flex-col justify-end gap-4 items-center md:items-end text-sm font-subhead capitalize overflow-y-hidden space-y-4 md:space-y-8 pb-8 ">
