...
export default function PersonalInfoSection() {
  return (
    <section className="py-20 grid grid-cols-8 md:grid-cols-12 pb-10">
      {/* section title */}
      <div className="text-xs md:text-base col-span-1 md:col-span-2 text-end">
        [ I'm ]
      </div>

      {/* personal information */}
      <div className="col-span-7 md:col-span-10 flex justify-end w-full">
        <p className="text-base md:text-5xl capitalize indent-8 md:indent-28 mb-4 md:mb-12 font-mainHead">
